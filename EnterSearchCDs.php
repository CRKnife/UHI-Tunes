...
<body>
    <h1>Catalogue Search</h2>
	<h2>Enter search critera</h2>

<form method="post" action="SearchCDs.php">
<table>
 <tr>
  <td>CD number:</td>
  <td><input type="number" name="CDNbr" size="6"/></td>
 </tr>
 <tr>
  <td>CD Title:</td>
  <td><input type="text" name="CDTitle" size="30"/></td>
 </tr>
 <tr>
  <td>Label:</td>
 ...
 <tr>
  <td>Artist Name:</td>
  <td><input type="text" name="ArtistName" size="30"/></td>
 </tr>
  <tr>
  <td colspan="2"><input type="submit" value="Search CDs"/></td>
 </tr>
 <tr>
