...
<form method="post" action="SearchCDTracks.php">
<table>
 <tr>
  <td>CD number:</td>
 ...
 <tr>
  <td>CD Title:</td>
  <td><input type="text" name="CDTitle" size="10"/></td>
 </tr>
 <tr>
  <td>Release Year:</td>
  <td><input type="text" name="ReleaseYear" size="10"/></td>
 </tr>
 <tr>
  <td>Artist Name:</td>
  <td><input type="text" name="ArtistName" size="10"/></td>
 </tr>
  <tr>
  <td colspan="2"><input type="submit" value="Search CD Tracks"/></td>
 </tr>
 <tr>
...
</path></svg></span><span style="display:inline-block;padding:2px 3px;">Ali Yahya</span></a>
<footer>
